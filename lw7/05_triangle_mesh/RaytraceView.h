...
private:
	...
	CSceneObject& AddTriangleMesh(IShader const& shader, std::shared_ptr<CTriangleMeshData const> pMeshData, CMatrix4d const& transform = CMatrix4d());
	CSceneObject& AddDodecahedron(IShader const& shader, CMatrix4d const& transform);
	CSceneObject& AddCube(IShader const& shader, CMatrix4d const& transform);
	CSceneObject& AddTetrahedron(IShader const& shader, CMatrix4d const& transform);
	CSceneObject& AddIcosahedron(IShader const& shader, CMatrix4d const& transform);
	CSceneObject& AddOctahedron(IShader const& shader, CMatrix4d const& transform);
